...
![Обзор распределений SciFact](static/scifact_eda_overview.png){#fig-scifact-overview width=88%}
...
![C4-диаграмма системы SciGuide](static/archon-c4-sciguide.png){#fig-sciguide-architecture width=92%}
